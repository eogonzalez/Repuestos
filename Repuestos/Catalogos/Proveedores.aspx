<%@ Page Title="Proveedores" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="Repuestos.Catalogos.Proveedores" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body form-vertical">
            ...
            <div>
                <asp:GridView runat="server" ID="gvProveedores"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="id_proveedor" SortExpression="id_proveedor" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
    ...
    <div>
        ...
        <asp:Panel runat="server" ID="pnl_nuevo" CssClass="panel panel-primary" BorderColor="Black" BackColor="White"
            ...
            <div class="panel-body form-horizontal">
                ...
                <%--Campo Nombre--%>
                <div class="form-group">
                    <asp:Label AssociatedControlID="txtNombre" CssClass="control-label col-xs-4" runat="server" Text="Nombre Proveedor: "></asp:Label>
                    <div class="col-xs-8">
