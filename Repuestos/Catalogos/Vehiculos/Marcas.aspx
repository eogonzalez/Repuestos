<%@ Page Title="Marcas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Marcas.aspx.cs" Inherits="Repuestos.Catalogos.Marcas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body form-vertical">
            ...
            <div>
                <asp:GridView runat="server" ID="gvMarcas"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="id_marca" SortExpression="id_marca" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
        ...
        <asp:Panel runat="server" ID="pnl_nuevo" CssClass="panel panel-primary" BorderColor="Black" BackColor="White"
            ...
            <div class="panel-body form-horizontal">
                ...
                <div class="form-group">
                    <asp:Label AssociatedControlID="txtMarca" CssClass="control-label col-xs-4" runat="server" Text="Marca: "></asp:Label>
                    <div class="col-xs-8">
