<%@ Page Title="Vehiculos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vehiculos.aspx.cs" Inherits="Repuestos.Catalogos.Vehiculos.Vehiculos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body form-vertical">
            ...
            <div>
                <asp:GridView runat="server" ID="gvVehiculos"
                    ...
                    OnPageIndexChanging="gvVehiculos_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="id_vehiculo" SortExpression="id_vehiculo" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
