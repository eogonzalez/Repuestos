<%@ Page Title="Modelos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Modelos.aspx.cs" Inherits="Repuestos.Catalogos.Modelos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body form-vertical">
            ...
            <div>
                <asp:GridView runat="server" ID="gvModelos"
                    CssClass="table table-hover table-striped"
                    GridLines="None"
                    EmptyDataText="No Existen registros."
                    AutoGenerateColumns="false"
                    AllowPaging="true"
                    OnRowCommand="gvModelos_RowCommand"
                    OnPageIndexChanging="gvModelos_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="id_modelo" SortExpression="id_marca" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
        ...
        <asp:Panel runat="server" ID="pnl_nuevo" CssClass="panel panel-primary" BorderColor="Black" BackColor="White"
            ...
            <div class="panel-body form-horizontal">
                ...
                <div class="form-group">
                    <asp:Label AssociatedControlID="txtModelo" CssClass="control-label col-xs-4" runat="server" Text="Modelo: "></asp:Label>
                    <div class="col-xs-8">
                        <asp:TextBox ID="txtModelo" type="number" CssClass="form-control" runat="server"></asp:TextBox>
