<%@ Page Title="Tipos de Vehiculos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoVehiculos.aspx.cs" Inherits="Repuestos.Catalogos.Vehiculos.TipoVehiculos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body form-vertical">
            ...
            <div>
                <asp:GridView runat="server" ID="gvTipoVehiculos"
                    CssClass="table table-hover table-striped"
                    GridLines="None"
                    EmptyDataText="No Existen registros."
                    AutoGenerateColumns="false"
                    AllowPaging="true"
                    OnRowCommand="gvTipoVehiculos_RowCommand"
                    OnPageIndexChanging="gvTipoVehiculos_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="id_tipo_vehiculo" SortExpression="id_tipo_vehiculo" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
                        <asp:BoundField DataField="tipo" HeaderText="Tipo Vehiculo" />
        ...
        <asp:Panel runat="server" ID="pnl_nuevo" CssClass="panel panel-primary" BorderColor="Black" BackColor="White"
            ...
            <div class="panel-body form-horizontal">
                ...
                <div class="form-group">
                    <asp:Label AssociatedControlID="txtTipo" CssClass="control-label col-xs-2" runat="server" Text="Tipo Vehiculo: "></asp:Label>
                    <div class="col-xs-10">
                        <asp:TextBox ID="txtTipo" type="text" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtTipo"
